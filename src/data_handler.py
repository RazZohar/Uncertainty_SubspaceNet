...
def create_dataset(
    ...
    if model_type.startswith("DeepCNN") and phase.startswith("train"):
        ...
        model_dataset, generic_dataset = create_samples(model_type, phase, samples_model, samples_size, tau, true_doa)
...
def create_samples(model_type, phase, samples_model, samples_size, tau, true_doa):
    """
    Retrive Samples within model/ Generic manner due to the DOA and samples model
    Args:
        model_type:
        phase:
        samples_model:
