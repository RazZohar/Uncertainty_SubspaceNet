...
Notes:
- The multi-subarray checkpoint defaults to best_base_reliability.pth and is reported as SSN Stage 2.
...
def main(argv: Optional[List[str]] = None) -> List[Dict[str, Any]]:
    ...
    parser.add_argument("--multi_subarray_checkpoint_name", default="best_base_reliability.pth",
                        help="Checkpoint filename to evaluate under each multi_subarray directory. Default loads SSN Stage 2 best_base_reliability.pth.")
